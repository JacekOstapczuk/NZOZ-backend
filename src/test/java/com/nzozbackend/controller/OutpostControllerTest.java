...
class OutpostControllerTest {
    ...
    @Test
    public void testOutpostControllerCreateOutpost() throws Exception {
        //Given
    ...
    @Test
    public void testOutpostControllerGetOutposts() throws Exception {
//Given
        Visit visit = new Visit(LocalDate.now());
        List<Visit> visitList = new ArrayList<Visit>();
        visitList.add(visit);
    ...
    @Test
    public void testOutpostControllerUpdateOutpost() throws Exception {
//Given
        Visit visit = new Visit(LocalDate.now());
        List<Visit> visitList = new ArrayList<Visit>();
        visitList.add(visit);
    ...
    @Test
    public void testOutpostControllerDeleteOutpost() throws Exception {
//Given
        Visit visit = new Visit(LocalDate.now());
        List<Visit> visitList = new ArrayList<Visit>();
        visitList.add(visit);
